...
export const lineOptions1_y_100 = (
  arr: any,
  date: any,
  linetype: boolean = false,
  type: any
...
export const lineOptions_lineAndbar = (
  ...
  return {
    ...
    series: arr?.map(
      (i: { name: any; type: any; data: any }, index: number) => {
        return {
          name: i.name,
          // stack: 'Total',
          symbolSize: 1, // 设置数据点的大小为8像素
...
export const currencyLineOptions = (
  arr: any,
  date: any,
  linetype: boolean = false,
  type: any
  ...
  return {
    ...
    series: arr?.map(
      (i: { name: any; data: any; yAxisIndex: any }, index: number) => {
        return {
          name: i.name,
          stack: i.name,
    ...
    tooltip: {
      ...
      formatter: function (params) {
        return (
          ...
          params.value +
          " (" +
          parseFloat((params.data.cost_rate * 100).toFixed(2)) +
          ") %" +
          "<br/>" +
          "GMV" +
          " : " +
          params.data.gmv +
          " (" +
          parseFloat((params.data.gmv_rate * 100).toFixed(2)) +
          ") %" +
          "<br/>" +
          "ROI" +
          " : " +
    ...
    tooltip: {
      ...
      formatter: function (params) {
        return (
          ...
          "花费占比" +
          " : " +
          parseFloat((params[0].data.zhanbi * 100).toFixed(2)) +
          " %" +
          "<br/>" +
          "ROI" +
          " : " +
          parseFloat((params[0].data.roi * 100).toFixed(2)) +
          "</div>"
        );
      },
    },
...
export const XYlineOptionspalletAnalysis1 = (
  date: any,
  shop: any,
  industry: any
) => {
...
export const XYlineOptionspalletAnalysis2 = (
  date: any,
  shop: any,
  industry: any
) => {
  ...
  return {
    tooltip: {
      ...
      formatter: function (params) {
        return (
          "<div>" +
          '<span class="echartsToolTip">sku名称</span>' +
          params[0].name +
          "<br>" +
          '<span class="echartsToolTip">支付金额</span>' +
          params[0].value +
          "<br/>" +
          '<span class="echartsToolTip">支付买家数</span>' +
          parseFloat(params[0].data.pay_buyers.toFixed(2)) +
          "" +
          "<br/>" +
          '<span class="echartsToolTip">支付件数</span>' +
          parseFloat(params[0].data.pay_quantity.toFixed(2)) +
          "<br/>" +
          '<span class="echartsToolTip">加购件数</span>' +
          parseFloat(params[0].data.add_to_cart_count.toFixed(2)) +
          "<br/>" +
          "</div>"
        );
      },
    ...
    tooltip: {
      ...
      formatter: function (params) {
        return (
          ...
          "<br/>" +
          '<span class="echartsToolTip">支付买家数</span>' +
          parseFloat(params.data.pay_buyers.toFixed(2)) +
          "" +
          "<br/>" +
          '<span class="echartsToolTip">支付件数</span>' +
          parseFloat(params.data.pay_quantity.toFixed(2)) +
          "<br/>" +
          '<span class="echartsToolTip">加购件数</span>' +
          parseFloat(params.data.add_to_cart_count.toFixed(2)) +
          "<br/>" +
          "</div>"
        );
      },
    ...
    tooltip: {
      ...
      formatter: (params) => {
        return `${params.marker}${params.name}:<br/> ${
          lueNum(params.value) + "(" + params.percent
        }%)`;
      },
    },
    // title: {
...
export const lineFillOptionsNum = (arr: any, times: any, type: any) => {
  return {
    tooltip: {
      ...
      formatter: (params: any) => {
        if (type == "%") {
          return `${params[0].axisValue}<br />${persentNum(
            params[0].value
          )}${type}`;
        } else {
