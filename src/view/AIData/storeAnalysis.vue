                                ...
                                <el-row>
                                    <el-col :span="5">
                                        <div style="height: 140px;">
                                            <div class="numS">
                                                {{ persentNum(numS.data.shop_service_analysis.first_product_return_rate) }}%
                                            </div>
                                            <div class="describe">
                                                首次品退率
                                            </div>
                            ...
                            <el-col :span="24">
                                <el-row>
                                    ...
                                    <el-col :span="9">
                                        ...
                                        <div style="position: absolute;top:0;left: 50%;width: 100%;transform: translateX(-50%);">
                                            <div class="numS">
                                                {{
                                ...
                                <el-row>
                                    ...
                                    <el-col :span="8">
                                        ...
                                        <div style="position: absolute;top:0;left: 50%;transform: translateX(-50%);">
                                            ...
                                            <div class="numS">
                                                {{ floatNum(numS.data.customer_service.customer_service_sales_ratio*100) }}%
                                            </div>
                                        </div>
                                    </el-col>
                                    <el-col :span="8">
                                        ...
                                        <div style="position: absolute;top:0;left: 50%;transform: translateX(-50%);">
                                            ...
                                            <div class="numS">
                                                {{ lueNum(numS.data.customer_service.average_response_time_in_seconds) }}
                                            </div>
                                        </div>
                                    </el-col>
                                </el-row>
