 ...
 * @LastEditTime: 2024-01-22 18:17:26
...
const boxData = ref([
    { title: '无界词', height: '320px', chartsData: [] },
    { title: '生参付费词', height: '320px', chartsData: [] },
    { title: '生参免费词', height: '320px', chartsData: [] },
    { title: '生参行业词', height: '320px', chartsData: [] },
])
